            ...
            <div className="max-w-sm mx-auto flex flex-col gap-4 m-4 p-4 bg-[#cfd8cec1] rounded-sm">
                <div className="relative z-0">
                    <input
                        ...
                        id="first_name"
                        value={firstName}
                        onChange={(e)=> setFirstName(e.target.validity)}
                ...
                <div className="relative">
                  ...
                  <button type='submit' className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 inline-flex items-center" onClick={handleSubmit}>Submit</button>
            </div>
        </>
    );
}
